...
namespace Soma.Platform.Api.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoginAt = table.Column<DateTime>(type: "DATE", nullable: true),
                    Is2FARequired = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    ...
                    VerificationTokenExpiry = table.Column<DateTime>(type: "DATE", nullable: true),
                    GoogleId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    AppleId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_VerificationToken",
                table: "AspNetUsers",
